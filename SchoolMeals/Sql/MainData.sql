...
insert into [dbo].[Languages] ([Name], [NameAbbreviation], [Slug], [Default]) values 
(N'Українська', 'UA', 'ukrainian', 1),
(N'Русский', 'RU', 'russian', 0),
...
insert into [dbo].[Dishes] ([Name], [Slug], [Description], [Image], [IsRecommend], [CategoryId], [LanguageId], [CreateAt], [UpdateAt]) values 
(N'Гречаний суп', 'buckwheat-soup', N'Суп з гречаної крупи - традиційне блюдо української та білоруської кухні, що представляє собою суп, приготований на мясному бульйоні або на бульйоні з кісток, яловичих або свинячих, з додаванням гречаної крупи.', '8.jpg', 1, 2, 1, CONVERT(DATETIME2, '28.02.2021', 104), CONVERT(DATETIME2, '28.02.2021', 104)),
...
Приєднуйтесь до нас в приготуванні грибного крем супу і поповните свою колекцію фото рецептів приготування перших страв!', '8.jpg', 1, 3, 1, CONVERT(DATETIME2, '01.03.2021', 104), CONVERT(DATETIME2, '01.03.2021', 104)),
(N'Суп удон', 'udon-soup', N'Локшина удон це оригінальні макаронні вироби нарізної виду, вироблені на основі пшеничного борошна. Продукт користується широким попитом у жителів Азіатських країн, але останнім часом впевнено займає свої позиції і на вітчизняному ринку.', '8.jpg', 1, 4, 1, CONVERT(DATETIME2, '02.03.2021', 104), CONVERT(DATETIME2, '03.03.2021', 104)),
(N'Місо суп', 'miso-soup', N'Одне з національних надбань Японії - це місо суп. Є різні його варіації, залежить від регіону: з креветками, грибами, вегетаріанський. Записуйте рецепт, як приготувати місо суп класичний.', '8.jpg', 1, 4, 1, CONVERT(DATETIME2, '03.03.2021', 104), CONVERT(DATETIME2, '03.03.2021', 104)),
(N'Цезар з куркою', 'caesar-with-chicken', N'Салат «Цезар» - популярний салат, одне з найвідоміших страв північноамериканської кухні. У класичній версії основними складовими салату є пшеничні крутон (грінки), листя салату-ромен і тертий пармезан, заправлені соусом. Основа заправки «Цезар» - свіжі яйця, витримані 1 хвилину в окропі і охолоджені (або яйця в сорочках). Далі яйця збивають з оливковою олією і приправляють часником, лимонним соком і Вустерского соусом. У класичному вигляді салат виходить досить легким, тому до нього часто додають поживні складові, наприклад, круте яйце або смажену курку.', '8.jpg', 1, 5, 1, CONVERT(DATETIME2, '10.03.2021', 104), CONVERT(DATETIME2, '12.03.2021', 104)),

(N'Гречневый суп', 'buckwheat-soup', N'Суп из гречневой крупы - традиционное блюдо украинской и белорусской кухни, представляет собой суп, приготовленный на мясном бульоне или на бульоне из костей, говяжьих или свиных, с добавлением гречневой крупы.', '8.jpg', 1, 9, 2, CONVERT(DATETIME2, '28.02.2021', 104), CONVERT(DATETIME2, '28.02.2021', 104)),
...
Присоединяйтесь к нам в приготовлении грибного крем супа и пополните свою коллекцию фото рецептов приготовления первых блюд!', '8.jpg', 1, 10, 2, CONVERT(DATETIME2, '01.03.2021', 104), CONVERT(DATETIME2, '01.03.2021', 104)),
(N'Суп удон', 'udon-soup', N'Лапша удон это оригинальные макаронные изделия нарезного вида, произведенные на основе пшеничной муки. Продукт пользуется широким спросом у жителей Азиатских стран, но в последнее время уверенно занимает свои позиции и на отечественном рынке.', '8.jpg', 1, 11, 2, CONVERT(DATETIME2, '02.03.2021', 104), CONVERT(DATETIME2, '03.03.2021', 104)),
(N'Мисо суп', 'miso-soup', N'Одно из национальных достояний Японии - это мисо суп. Есть разные его вариации, зависит от региона: с креветками, грибами, вегетарианский. Записывайте рецепт, как приготовить мисо суп классический.', '8.jpg', 1, 11, 2, CONVERT(DATETIME2, '03.03.2021', 104), CONVERT(DATETIME2, '03.03.2021', 104)),
(N'Цезарь с курицей', 'caesar-with-chicken', N'Салат «Цезарь» - популярный салат, одно из самых известных блюд североамериканской кухни. В классической версии основными составляющими салата являются пшеничные крутоны (гренки), листья салата-ромэн и тертый пармезан, заправленные соусом. Основа заправки «Цезарь» - свежие яйца, выдержанные 1 минуту в кипятке и охлажденные (или яйца в рубашках). Далее яйца взбивают с оливковым маслом и приправляют чесноком, лимонным соком и Вустерского соусом. В классическом виде салат получается довольно легким, поэтому к нему часто добавляют питательные составляющие, например, крутое яйцо или жареную курицу.', '8.jpg', 1, 12, 2, CONVERT(DATETIME2, '10.03.2021', 104), CONVERT(DATETIME2, '12.03.2021', 104)),

('Buckwheat soup', 'buckwheat-soup', 'Buckwheat soup - a traditional dish of Ukrainian and Belarusian cuisine, which is a soup made from meat broth or broth from bones, beef or pork, with the addition of buckwheat.', '8.jpg', 1, 16, 3, CONVERT(DATETIME2, '28.02.2021', 104), CONVERT(DATETIME2, '28.02.2021', 104)),
...
Join us in the preparation of mushroom cream soup and add to your collection of photos of recipes for cooking first courses!', '8.jpg', 1, 17, 3, CONVERT(DATETIME2, '01.03.2021', 104), CONVERT(DATETIME2, '01.03.2021', 104)),
('Udon soup', 'udon-soup', 'Udon noodles are original sliced pasta made from wheat flour. The product is in great demand among residents of Asian countries, but recently confidently takes its place in the domestic market.', '8.jpg', 1, 18, 3, CONVERT(DATETIME2, '02.03.2021', 104), CONVERT(DATETIME2,'03.03.2021', 104)),
('Miso soup', 'miso-soup', 'One of the national treasures of Japan is miso soup. There are different variations, depending on the region: with shrimp, mushrooms, vegetarian. Write down the recipe for how to cook miso classic soup.', '8.jpg', 1, 18, 3, CONVERT(DATETIME2, '03.03.2021', 104), CONVERT(DATETIME2, '03.03.2021', 104)),
('Caesar with chicken', 'caesar-with-chicken', 'Caesar salad is a popular salad, one of the most famous dishes of North American cuisine. In the classic version, the main ingredients of the salad are wheat croutons (croutons), romaine lettuce leaves and grated parmesan, dressed with sauce. The basis of the Caesar dressing is fresh eggs, kept in boiling water for 1 minute and chilled (or eggs in shirts). Next, the eggs are beaten with olive oil and seasoned with garlic, lemon juice and Worcester sauce. In the classic form, the salad turns out to be quite light, so nutritious components, for example, a hard egg or fried chicken, are often added to it.', '8.jpg', 1, 19, 3, CONVERT(DATETIME2, '10.03.2021', 104), CONVERT(DATETIME2, '12.03.2021', 104));
